...
NEW_PRIOR = 'children:[!T.ZP.isRTL()&&i,this.props.name===P.kToolbarsNavigation&&(0,Hi.jsx)(ncChromeMenu,{keyAccess:this.props.keyAccess,inert:!!this.props.inert}),this.state.buttons.map'
NEW = 'children:[!T.ZP.isRTL()&&i,this.props.name===P.kToolbarsNavigation&&!a&&!this.state.modifier&&!this.props.showDefaultSet&&(0,Hi.jsx)(ncChromeMenu,{key:"nc-chrome-menu",keyAccess:this.props.keyAccess,inert:!!this.props.inert}),this.state.buttons.map'
...
def transform(source):
    ...
    if source.count(NEW_PRIOR) == 1 and source.count(NEW) == 0:
        source = source.replace(NEW_PRIOR, NEW, 1)
    pairs = [
        (OLD, NEW),
