...
css += ['#browser.tabs-top #tabs-container.top .tab .close > svg { visibility:hidden; }', f'#browser.tabs-top #tabs-container.top .tab .close::after {{ content:""; width:16px !important; height:16px !important; flex:0 0 16px; background:currentColor; mask:{svg("close_weight500.icon",24)} center / contain no-repeat; }}']
