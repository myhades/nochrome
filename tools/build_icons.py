...
css += [f'#browser .toolbar-addressbar .OmniLinkItem-EraseButton::before {{ content:""; position:absolute; inset:0; background:currentColor; mask:{svg("close.icon",24)} center / 18px 18px no-repeat; pointer-events:none; }}']
...
css += ['#browser .bookmark-bar .bookmarkbarItem.folder > .folder-icon { display:none !important; }', f'#browser .bookmark-bar .bookmarkbarItem.folder::before {{ content:""; width:20px; height:20px; flex:0 0 20px; background:currentColor; mask:{svg("folder_chrome_refresh_old.icon",20)} center / contain no-repeat; }}']
