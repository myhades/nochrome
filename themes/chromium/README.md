...
- `chrome/app/vector_icons/`: add, more_vert, reading_list_old, download_toolbar_button_chrome_refresh_old, download.
- `components/vector_icons/`: folder_chrome_refresh_old.
